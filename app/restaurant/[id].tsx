...
import { View, StyleSheet, ScrollView, TouchableOpacity, Dimensions, FlatList, StatusBar, SectionList, Text } from 'react-native';
...
export default function RestaurantDetailScreen() {
      ...
      return (
        <View style={styles.menuItem}>
            ...
            <View style={styles.menuItemImageContainer}>
                ...
                {item.customizable && <ThemedText style={styles.customizableText}>customisable</ThemedText>}
            </View>
        </View>
      );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {/* FLOATING MENU FAB */}
      <TouchableOpacity style={[styles.menuFab, cartCount > 0 && { bottom: 90 }]}>
